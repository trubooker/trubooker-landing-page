  ...
  return (
    <div>
      ...
      <div className="text-center">
        <div className="w-full bg-[--primary] font-semibold text-sm lg:text-base flex flex-col lg:flex-row py-2 lg:py-0 lg:justify-around text-white justify-center text-center">
          <p className="my-auto">
