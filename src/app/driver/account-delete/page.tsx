...
const DriverAccountDelete = () => {
  ...
  return (
    <section className="grid lg:grid-cols-2 grid-cols-1 gap-y-5 h-full">
      <button
        onClick={handleBack}
      ...
      <div className="w-full h-full lg:h-screen lg:flex lg:flex-col text-center justify-center my-auto overflow-y-auto ">
          ...
          <div className="text-center mx-auto">
            <div className="w-full text-left bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="mt-2 text-sm text-gray-600 text-justify list-disc list-inside space-y-1">
                ...
                <li>You will no longer receive gains on completed trips.</li>
                <li>
